function [Accuracy, Sensitivity, Specificity] = SVM_2group_NFolds(Subjects_Data, Subjects_Label, Fold_Quantity, C_Parameter, ResultantFolder)
%
% Subject_Data:
%           m*n matrix
...
if nargin > 5 & ~exist(ResultantFolder, 'dir')
...
for i = 1:Fold_Quantity
    ...
    model(i) = svmtrain(Label, Training_all_data, ['-t 0 -c ' num2str(C_Parameter)]);

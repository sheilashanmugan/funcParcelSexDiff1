...
pval1 <- read.csv( "/cbica/projects/funcParcelSexDiff/results/genetics/permutations/img100_schaefer10K_geneNoF_permSphereP_df_20201109.csv")
pval <- pval1[,-1]
...
t2 <- sapply(1:15036, function(x) cor(data_parc_lh_sort_200$wt_mean,geneMatChrom_200[,x]))
df2$corr <- t2

...
Behavior_Mat.Behavior_data_old.sex_new= zeros(231,1);
Covariate_mat=zeros(231,2);
Covariate_mat(:,1)=Behavior_Mat.Behavior_data_old.AgeYears;
Covariate_mat(:,2)=Behavior_Mat.Behavior_data_old.Motion;

BBLID = Behavior_Mat.Behavior_data_old.BBLID;
load('/cbica/projects/funcParcelSexDiff/results/AtlasLoading/tertiles/old/AtlasLoading/AtlasLoading_All_RemoveZero.mat'); % NonZeroIndex is here

for i = 1:length(BBLID)
    if Behavior_Mat.Behavior_data_old.Sex(i)>1.5
       Behavior_Mat.Behavior_data_old.sex_new(i) = 1;
    else
       Behavior_Mat.Behavior_data_old.sex_new(i) = -1;
    end
end
...
Subjects_Label = Behavior_Mat.Behavior_data_old.sex_new';
Fold_Quantity= 2;
Pre_Method = 'Scale';
CVRepeatTimes = 10;
C_Range = 2.^(-5:10);
...
% 100 Repeat
Subjects_Data_Path = '/cbica/projects/funcParcelSexDiff/results/AtlasLoading/tertiles/old/AtlasLoading/Subjects_Data.mat'; % is this the same thing?'/cbica/projects/pncSingleFuncParcel/Chead_Backup/Sheila/runSVM/Subjects_Data.mat';
save(Subjects_Data_Path, 'Subjects_Data');
CVRepeatTimes_Range = [1:100];
ResultantFolder = '/cbica/projects/funcParcelSexDiff/results/PredictionAnalysis/SVM/2fold_CSelect_Cov_SubIndex/Sex_CovAgeMotion/tertiles/old/Permutation/res_MultiTimes';
...
ResultantFolder = '/cbica/projects/funcParcelSexDiff/results/PredictionAnalysis/SVM/2fold_CSelect_Cov_SubIndex/Sex_CovAgeMotion/tertiles/old/Permutation/res_Permutation';

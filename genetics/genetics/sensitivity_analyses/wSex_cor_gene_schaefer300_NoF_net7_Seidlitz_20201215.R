...
lh_schaefer300_ct <- read.table("/cbica/projects/funcParcelSexDiff/inputData/genetics/seidlitz/schaefer300/lh_Schaefer300_7net_Sedlitz_cttable.csv")
...
geneMat <- readMat("/cbica/projects/funcParcelSexDiff/inputData/genetics/seidlitz/schaefer300_NoF/gene_regional_expression_zscored_NoF.mat")
...
t2 <- sapply(1:15036, function(x) cor(data_parc_lh_sort_150_comp,geneMatChrom_150_comp_fin[,x]))

...
load('/cbica/projects/funcParcelSexDiff/results/genetics/parc_mat/w_Brain_Sex_Abs_sum_schaefer1000_lh.mat');
...
V_lh_File = [outdir 'w_Brain_Sex_Abs_sum_schaefer1000_lh.func.gii'];
save(V_lh, V_lh_File);
...
clear
addpath(genpath('/cbica/projects/pncSingleFuncParcel/Replication/Toolbox/Code_mvNMF_l21_ard_v3_release/'));
load('/cbica/projects/funcParcelSexDiff/results/genetics/parc_mat/w_Brain_Sex_Abs_sum_schaefer1000_7net_lh.mat');
...
V_lh.cdata = parc_vert;
outdir = '/cbica/projects/funcParcelSexDiff/results/genetics/parc_mat/'
V_lh_File = [outdir 'w_Brain_Sex_Abs_sum_schaefer1000_7net_lh.func.gii'];
save(V_lh, V_lh_File);
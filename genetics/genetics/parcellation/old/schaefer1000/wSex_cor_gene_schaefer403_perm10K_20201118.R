...
df3 <- merge(df2, chromGeneRefined, by.x="gene", by.y="geneRefined", all=TRUE) #checked corr values match for A2M, AANAT, ABAT 
# cor(data_parc_lh_sort_500_comp,geneMatChrom_500_comp_fin$AANAT)
# [,1]
# wt_mean -0.03101082
# > cor(data_parc_lh_sort_500_comp,geneMatChrom_500_comp_fin$ABAT)
# [,1]
# wt_mean 0.04929793
...
writeMat("/cbica/projects/funcParcelSexDiff/results/genetics/schaefer1000/ttest/XY_ttest_schaefer1000.mat", XY_ttest_vert = XY_ttest_vert)

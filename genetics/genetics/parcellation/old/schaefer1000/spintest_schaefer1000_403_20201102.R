...
set.seed(1)
img_gene_permSphereP <- mclapply(geneMatChrom_500_comp_fin, FUN=perm.sphere.p, y=data_parc_lh_sort_500_comp_vec, perm.id= schaefer1000_perm_lh, corr.type='pearson', mc.set.seed =  TRUE, mc.cores=getOption("mc.cores", 25))

...
parcellation_name='Schaefer2018_400Parcels_17Networks_order_cortex_LH.nii.gz';
...
step4_createGeneExpressionTable_NoF(hemiMirror);

display('Generate gene expression and coexpression matrices');
step5_interpolateRegions_NoF(hemiMirror,parcellation_name);

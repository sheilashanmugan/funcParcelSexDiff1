...
path_Allen='/Users/sheilash/Desktop/projects/pfn_sex_diff/scripts/genetics/allen_processing/geneExpression_Repository/AIBS_map/';
...
dir_img=dir([path_genes_general 'raw_NoF/']);
...
for img=1:numel(folder_name_list)
    ...
    path_subject=[path_genes_general 'raw_NoF/' donor_name '/'];
...
%Save files
path_output='/Users/sheilash/Desktop/projects/pfn_sex_diff/scripts/genetics/allen_processing/geneExpression_Repository/AIBS_map/gene_matrices_hemi_mirror/ExcludeFemaleDonor/';


[s1 s2 s3]=mkdir(path_output);
save([path_output 'gene_regional_expression_NoF.mat'],'gene_regional_expression');
gene_regional_expression=zscore(gene_regional_expression);
save([path_output 'gene_regional_expression_zscored_NoF.mat'],'gene_regional_expression');
gene_regional_correlations=corrcoef(gene_regional_expression');
save([path_output 'gene_regional_correlations_NoF.mat'],'gene_regional_correlations');
save([path_output 'parc_cortex_samples_NoF.mat'],'parc_cortex_samples');
save([path_output 'parc_cortex_ratio_NoF.mat'],'parc_cortex_ratio');

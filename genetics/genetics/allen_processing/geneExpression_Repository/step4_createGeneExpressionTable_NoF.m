...
for ifol=1:numel(folder_name_list)
    ...
    mkdir([path_output 'raw_NoF/' folder_name]);
    %samples_coor_vox contains the voxels location of each sample in T1
    %freesurfer space
    save([path_output 'raw_NoF/' folder_name '/samples_coor_vox.mat'],'samples_coor_vox');
    save([path_output 'raw_NoF/' folder_name '/gene_samples.mat'],'gene_samples');
    save([path_output 'raw_NoF/' folder_name '/gene_samples_cx_index.mat'],'gene_samples_cx_index');
    save([path_output 'raw_NoF/' folder_name '/samples_coor_mni.mat'],'samples_coor_mni');

...
system("echo line 62")
rois <- read.csv("/cbica/projects/funcParcelSexDiff/inputData/genetics/sensitivity_analyses/parcellation/data/genes/parcellations/github/Schaefer2018_1000Parcels_17Net_order_2mmCentroid_RAS_copy2.csv")
setDT(rois, keep.rownames = "parcNum")
roislh <- rois[1:500,]
system("echo line 66")

#img_geneMatChrom_roi_500 <- merge(roislh, img_geneMatChrom_500, by.x = "RoiLabel", by.y= "parcNum",all = FALSE)
img_geneMatChrom_roi_500 <- merge(roislh,img_geneMatChrom_500, by="parcNum")

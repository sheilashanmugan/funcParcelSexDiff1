#brain input is from SVM run 100x. Parcels ordered by original order for perm test instead of order of color table.
library(R.matlab)
library(dplyr)
library(magrittr)
library(tibble)
...
setDT(lh_schaefer400_ct_200, keep.rownames = "network")

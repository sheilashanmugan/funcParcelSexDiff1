...
write.csv(img_geneMatChrom_roi_500_comp, "/cbica/projects/funcParcelSexDiff/results/genetics/permutations/img_geneMatChrom_roi_500_comp.csv")

system("echo line 71")

data_parc_lh_sort_500_comp <- subset(img_geneMatChrom_roi_500_comp, select=wt_mean)
write.csv(data_parc_lh_sort_500_comp, "/cbica/projects/funcParcelSexDiff/results/genetics/permutations/data_parc_lh_sort_500_comp.csv")
...
write.csv(geneMatChrom_500_comp_fin, "/cbica/projects/funcParcelSexDiff/results/genetics/permutations/geneMatChrom_500_comp_fin.csv")
# 

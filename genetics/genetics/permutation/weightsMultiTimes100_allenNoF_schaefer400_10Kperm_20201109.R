...
set.seed(1)
img_gene_permSphereP <- mclapply(geneMatChrom_200, FUN=perm.sphere.p, y=data_parc_lh_sort_200_vec, perm.id= schaefer_perm, corr.type='pearson', mc.set.seed =  TRUE, mc.cores=getOption("mc.cores", 30))


write.csv(img_gene_permSphereP, "/cbica/projects/funcParcelSexDiff/results/genetics/permutations/img100_schaefer10K_geneNoF_permSphereP_df_20201109.csv")
